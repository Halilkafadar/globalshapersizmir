...
export const modulesData: Module[] = [
  ...
  },
  {
    ...
    coreContent: [
      ...
      'AI as a Sparring Partner: Instead of asking AI to do your homework, ask it to help you think through problems—like having a study buddy who never gets tired',
    ...
    interactiveElement: 'A "Prompt Practice Arena" where students can experiment with different prompt structures using real-time feedback for clarity, context, and constraints. They can see how changing persona, context, and task affects AI outputs in real-time, with scoring for most effective prompts.',
    ...
    topics: [
      ...
      'AI as Sparring Partner methodology',
    ...
    learningOutcomes: [
      ...
      'Transform AI into a personalized Sparring Partner',
  ...
  },
  {
    ...
    interactiveElement: 'An "Automotive Challenge" tool where students input real-world challenges and learn to break them into algorithmic steps. They can guide an AI agent through a logical system design process, seeing how different parts could be automated versus which parts need human creativity.',
  ...
  },
  {
    ...
    interactiveElement: 'A "Human Signature" interactive showcase using a slider or step-based component to demonstrate the transition from "Raw AI Output" to "Human-Refined Art". Students can adjust human input vs AI input to see how collaboration affects the final result.',
